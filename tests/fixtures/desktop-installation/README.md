...
Configure and Install buttons; its private installation URL band is blacked out
exactly as the hosted trial retains it. The fixture manifest URL points only to
a disposable loopback fixture server.
